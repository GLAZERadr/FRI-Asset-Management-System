<!-- Laboratorium Monitoring Reports Table -->
                ...
                @forelse ($monitoringReports as $report)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            @php
                                // Get room name from assets in this room - for lab it might be different naming
                                $roomAssets = $assets->where('kode_ruangan', $report->kode_ruangan);
                                $roomName = $roomAssets->first()->lokasi ?? 'Lab Room';
                                
                                // If it's a lab room, you might want to format it differently
                                if (strpos($report->kode_ruangan, 'LAB') !== false) {
                                    $roomName = 'Laboratorium ' . str_replace('LAB-', '', $report->kode_ruangan);
                                }
                            @endphp
                            {{ $roomName }}
                        </td>
                ...
                <tr>
                    <td colspan="8" class="px-6 py-10 text-center">
                        <div class="flex flex-col items-center">
                            ...
                            <h3 class="text-lg font-medium text-gray-900">Tidak Ada Data Laboratorium</h3>
                            <p class="text-gray-500">Belum ada laporan monitoring laboratorium yang tersedia.</p>
                        </div>
                    </td>
                </tr>
                @endforelse
