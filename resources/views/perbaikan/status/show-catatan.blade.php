            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    <div class="space-y-4">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <label class="block text-sm font-medium text-gray-600 mb-2">Rekomendasi</label>
                            <div class="bg-white p-3 rounded border">
                        ...
                        <!-- Rekomendasi Form -->
                        <form action="{{ route('perbaikan.status.report.update-catatan', $maintenanceAsset->maintenance_id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="bg-white p-4 rounded-lg border border-blue-200">
                                ...
                                <textarea id="catatan" 
                                          name="catatan" 
                                          rows="4"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('catatan') border-red-500 @enderror"
                                          placeholder="Berikan catatan terkait dengan perbaikan yang dilakukan...">{{ old('catatan', $maintenanceAsset->catatan) }}</textarea>
                                @error('catatan')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                                <p class="mt-1 text-xs text-gray-500">Opsional: Berikan catatan untuk pencegahan atau perbaikan selanjutnya</p>
                            </div>
